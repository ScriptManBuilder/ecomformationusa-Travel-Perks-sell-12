      ...
      <LegalPageContainer>
        ...
        <LegalContent>
          ...
          <LegalSection>
            ...
            <LegalList>
              <LegalListItem>
                <strong>Primary Descriptor:</strong> "{process.env.REACT_APP_BRAND_NAME?.toUpperCase() || 'TRAVEL SERVICE'}" or "{process.env.REACT_APP_BRAND_NAME?.toUpperCase() || 'TRAVEL'}*[Travel Service]"
              </LegalListItem>
              <LegalListItem>
                <strong>Alternative Descriptors:</strong> May include "{process.env.REACT_APP_BRAND_NAME?.toUpperCase() || 'TRAVEL'}" or travel provider names for specific bookings
              </LegalListItem>
              <LegalListItem>
